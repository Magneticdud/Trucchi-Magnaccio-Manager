...
int main() {
  ...
  //    patch=0;
  clrscr();
  printf("Questo programma ti farà diminuire la percentuale di polizia fino "
         "allo 0%%\n\n");
  ...
  printf("Adesso tutti i poliziotti sono morti!!!\nPuoi andare a "
         "giocare.\n\n\n\nPer eventuali bug contattare "
         "tipika@libero.it\nL\'Autore non si rende responsabile di eventuali "
         "danni\ncausati da questo programma, primo fra tutti l\'azzeramento "
         "dei progressi nel gioco.");
  getch();
  return (0);
}
